...
import 'package:hellolead/Common/JoinNowScreen.dart';

class CustomerSearchLand extends StatefulWidget {
  const CustomerSearchLand({super.key});

  @override
  State<CustomerSearchLand> createState() => _CustomerSearchLandState();
}

class _CustomerSearchLandState extends State<CustomerSearchLand> {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        children: [
                          Text("rent or sale",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600),),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Text("Rent",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600,color: Color(0xffF74682),),),
                                Icon(Icons.keyboard_arrow_down,size: 20,color: Color(0xffF74682),)
                              ],
                            ),
                          ),
                        ],
